...
TopFrameGui.BackgroundTransparency = 0.199
...
TpandBringKill.Position = UDim2.new(0.11, 0, 0.101, 0)
...
TpandBringKill.TextTransparency = 0.256
...
function TpandBring()
	...
	TpClickButton.Position = UDim2.new(0.11, 0, 0.673, 0)
	...
	CloseGui.TextTransparency = 0.359
